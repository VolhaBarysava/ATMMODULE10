...
public class TestBase {
	...
	protected static final String EXPECTED_FIRST_ACCOUNT = "vra_atmmodule5@mail.ru"; 
	protected static final String EXPECTED_SECOND_ACCOUNT = "vra_atmmodule6@mail.ru"; 
